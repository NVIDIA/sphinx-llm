...
| **Individual pages**                    | Outputs a Markdown rendered version for each page.                                                                                                                                                  | Not supported.                                                                                 |
...
| **Supported `llms.txt` output formats** | Markdown.                                                                                                                                                                                           | Passes through whatever the input format was.                                                  |
